class ServicesUrl{
  ...
  // static const String getTopPicks = "$baseUrl/api/books"; // lấy sách không có phân trang
  ...
  static const String editAccount = "$baseUrl/user/updateUser";
  ...
  static const String postBestSellers ="$baseUrl/api/book/bestSeller";

  static const String postFavourite ="$baseUrl/api/favourites";
  static const String getFavourite = "$baseUrl/api/favourites";
